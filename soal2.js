...
// logSampel that has been provided
const logSampel = `
...
// Writing the sample logs into a log.txt file
fs.writeFileSync('log.txt', logSampel);

console.log('Data telah ditulis ke dalam log.txt.');

// After writing the sample log, it will read log.txt.
fs.readFile('log.txt', 'utf-8', (err,logSampel) => {
    if (err) {console.error(err) };
    console.log("Data succesfully read :", logSampel);
})